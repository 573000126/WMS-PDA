...
namespace WinCEUtils
{
    public class Common
    {
        ...
        public static DialogResult MessageBoxInfo(string message)
        {
            return MessageBox.Show(message, "MES-Cloud温馨提示", MessageBoxButtons.OK, MessageBoxIcon.Asterisk, MessageBoxDefaultButton.Button1);
        }


        public static DialogResult MessageBoxQuestion(string message)
        {
            return MessageBox.Show(message, "MES-Cloud温馨提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
        }

        public static DialogResult MessageBoxEor(string message)
        {
            return MessageBox.Show(message, "MES-Cloud温馨提示", MessageBoxButtons.OK, MessageBoxIcon.Hand, MessageBoxDefaultButton.Button1);
        }
    }
}
